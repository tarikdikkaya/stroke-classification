...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # ViT-B-16 için önerilen giriş boyutu
...
# ------------------------- #
# 📌 ViT-B-16 (ImageNet-21K-P pretrain) Modeli
# ------------------------- #
class ViTModel(nn.Module):
    def __init__(self, num_classes=2):
        super(ViTModel, self).__init__()
        self.backbone = timm.create_model("vit_base_patch16_224_in21k", pretrained=True, num_classes=num_classes)
...
best_acc = 0.0
best_model_path = "best_model_vit_b_16.pth"
