"""Convolutional Vision Transformer (CvT) model implementation for medical image classification using PyTorch Lightning."""
...
class CvTW24(BaseMedicalModel):
    """
    Convolutional Vision Transformer (CvT-W24) model for medical image classification with PyTorch Lightning.
